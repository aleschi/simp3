...
export default ({ handleChange, handleSubmit, indicateurs, showSe, showMinistere,showBloc, autoCompleteList, regions,handleChange2 }) => {
			...
			<div>
		        ...
		        <div className="fr-grid-row fr-grid-row--gutters">
					...
					<div className="fr-col-12 fr-col-lg-4">
						...
						<select className="fr-select" id="regions" name="regions" onChange={handleChange2}>	<option value="ALL">Toutes les régions</option>  
					...
					<div className="fr-col-12 fr-col-lg-4">
						...
						<select className="fr-select" id="choixservice" name="secteur" onChange={handleChange2}>					
