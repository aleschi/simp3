        ...
        <div key={index}>
          <div className="fr-card fr-card--no-arrow fr-card-pointer">
            <div className="fr-card__body fr-pb-0">
              ...
              <div className="fr-text--sm fr-mb-3v">Performance globale du service : {(this.props.performance < 60) && <span className="fr-badge fr-badge--pink-tuile" > {this.props.performance}%</span>}{(this.props.performance >= 60 && this.props.performance < 80) && <span className="fr-badge fr-badge--yellow-tournesol" > {this.props.performance}%</span>}
              {(this.props.performance >= 80) && <span className="fr-badge fr-badge--green-emeraude" > {this.props.performance}%</span>}</div>
            
              <div className="fr-text--sm fr-mb-3v"><b>Valeurs des indicateurs sur le mois ({Moment(this.props.startDate).format('MM/YYYY')}) </b></div>
